...
├── sons/                     # Efeitos sonoros (prontos para implementação futura)
...
> **Nota:** A pasta `sons/` contém arquivos de áudio prontos para serem utilizados em uma futura implementação de efeitos sonoros no jogo.
